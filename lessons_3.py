...
#             for passangers in self.passengers:
...
#
# car = Auto("Audi")
# car.add_passangers(denis, roman, oleg)
...
job_list = {"Java Developer": {"salary": 50, "gladness_less": 10},
            ...
            "C# Developer": {"salary": 80, "gladness_less": 1},}
